...
使用 Node.js ethers 库生成 5 个钱包：3 验证者 + 1 部署者 + 1 国库。
...
> Clique PoA 3 验证者只需 2/3 在线即可继续出块。SIGNER\_LIMIT = floor(N/2)+1 = 2。
...
*Geth: v1.13.15 · Clique PoA · Chain ID: 7625*
