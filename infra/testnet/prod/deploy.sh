...
run_remote "$SERVER_A" "cd /opt/clawnet && \
  ...
  EMERGENCY_SIGNERS='$VALIDATOR_1_ADDRESS,$VALIDATOR_2_ADDRESS,$VALIDATOR_3_ADDRESS,$DEPLOYER_ADDRESS,$TREASURY_ADDRESS,$VALIDATOR_1_ADDRESS,$VALIDATOR_2_ADDRESS,$VALIDATOR_3_ADDRESS,$DEPLOYER_ADDRESS' \
