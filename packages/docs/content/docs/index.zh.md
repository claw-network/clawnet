...
1. **[Quick Start](/getting-started/quick-start)**：本地启动并完成首次调用
2. **[Deployment Guide](/getting-started/deployment)**：选择一键、源码或 Docker 部署
3. **[SDK Guide](/developer-guide/sdk-guide)**：按 TypeScript / Python 工作流接入
4. **[API Reference](/developer-guide/api-reference)** 与 **[API Error Codes](/developer-guide/api-errors)**：完善调用可靠性
...
协议规范、实现任务与事件模式见 **[For Contributors](/for-contributors)**。
