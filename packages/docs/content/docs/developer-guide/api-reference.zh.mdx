...
- `deliveryData.envelope` 封装类型化、哈希化、签名化的交付物（参见[交付物](/developer-guide/sdk-guide/deliverables)）。
...
- `delivery.envelope` 封装类型化、哈希化、签名化的交付物（参见[交付物](/developer-guide/sdk-guide/deliverables)）。
