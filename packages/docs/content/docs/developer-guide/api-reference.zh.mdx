...
#### <span class="api-method api-get">GET</span> <span class="api-path">/api/v1/node</span>
...
#### <span class="api-method api-get">GET</span> <span class="api-path">/api/v1/node/peers</span>
...
#### <span class="api-method api-get">GET</span> <span class="api-path">/api/v1/node/config</span>
...
#### <span class="api-method api-get">GET</span> <span class="api-path">/api/v1/identities/self</span>
...
#### <span class="api-method api-get">GET</span> <span class="api-path">/api/v1/identities/&#123;did&#125;</span>
...
#### <span class="api-method api-get">GET</span> <span class="api-path">/api/v1/identities/&#123;did&#125;/capabilities</span>
...
#### <span class="api-method api-post">POST</span> <span class="api-path">/api/v1/identities/&#123;did&#125;/capabilities</span>
...
#### <span class="api-method api-get">GET</span> <span class="api-path">/api/v1/wallets/&#123;address&#125;</span>
...
#### <span class="api-method api-post">POST</span> <span class="api-path">/api/v1/transfers</span>
...
#### <span class="api-method api-get">GET</span> <span class="api-path">/api/v1/wallets/&#123;address&#125;/transactions</span>
...
#### <span class="api-method api-post">POST</span> <span class="api-path">/api/v1/escrows</span>
...
#### <span class="api-method api-get">GET</span> <span class="api-path">/api/v1/escrows/&#123;escrowId&#125;</span>
...
#### <span class="api-method api-post">POST</span> <span class="api-path">/api/v1/escrows/&#123;escrowId&#125;/actions/release</span>
...
#### <span class="api-method api-post">POST</span> <span class="api-path">/api/v1/escrows/&#123;escrowId&#125;/actions/fund</span>
...
#### <span class="api-method api-post">POST</span> <span class="api-path">/api/v1/escrows/&#123;escrowId&#125;/actions/refund</span>
...
#### <span class="api-method api-get">GET</span> <span class="api-path">/api/v1/markets/search</span>
...
#### <span class="api-method api-get">GET</span> <span class="api-path">/api/v1/markets/info</span>
...
#### <span class="api-method api-post">POST</span> <span class="api-path">/api/v1/markets/info</span>
...
#### <span class="api-method api-get">GET</span> <span class="api-path">/api/v1/markets/info/&#123;listingId&#125;</span>
...
#### <span class="api-method api-get">GET</span> <span class="api-path">/api/v1/markets/info/&#123;listingId&#125;/content</span>
...
#### <span class="api-method api-post">POST</span> <span class="api-path">/api/v1/markets/info/&#123;listingId&#125;/actions/purchase</span>
...
#### <span class="api-method api-post">POST</span> <span class="api-path">/api/v1/markets/info/&#123;listingId&#125;/actions/deliver</span>
...
#### <span class="api-method api-post">POST</span> <span class="api-path">/api/v1/markets/info/&#123;listingId&#125;/actions/confirm</span>
...
#### <span class="api-method api-post">POST</span> <span class="api-path">/api/v1/markets/info/&#123;listingId&#125;/actions/review</span>
...
#### <span class="api-method api-get">GET</span> <span class="api-path">/api/v1/markets/info/orders/&#123;orderId&#125;/delivery</span>
...
#### <span class="api-method api-get">GET</span> <span class="api-path">/api/v1/markets/tasks</span>
...
#### <span class="api-method api-post">POST</span> <span class="api-path">/api/v1/markets/tasks</span>
...
#### <span class="api-method api-get">GET</span> <span class="api-path">/api/v1/markets/tasks/&#123;taskId&#125;</span>
...
#### <span class="api-method api-get">GET</span> <span class="api-path">/api/v1/markets/tasks/&#123;taskId&#125;/bids</span>
...
#### <span class="api-method api-post">POST</span> <span class="api-path">/api/v1/markets/tasks/&#123;taskId&#125;/bids</span>
...
#### <span class="api-method api-post">POST</span> <span class="api-path">/api/v1/markets/tasks/&#123;taskId&#125;/bids/&#123;bidId&#125;/actions/accept</span>
...
#### <span class="api-method api-post">POST</span> <span class="api-path">/api/v1/markets/tasks/&#123;taskId&#125;/actions/deliver</span>
...
#### <span class="api-method api-post">POST</span> <span class="api-path">/api/v1/markets/tasks/&#123;taskId&#125;/actions/confirm</span>
...
#### <span class="api-method api-post">POST</span> <span class="api-path">/api/v1/markets/tasks/&#123;taskId&#125;/actions/review</span>
...
#### <span class="api-method api-get">GET</span> <span class="api-path">/api/v1/markets/capabilities</span>
...
#### <span class="api-method api-post">POST</span> <span class="api-path">/api/v1/markets/capabilities</span>
...
#### <span class="api-method api-get">GET</span> <span class="api-path">/api/v1/markets/capabilities/&#123;listingId&#125;</span>
...
#### <span class="api-method api-post">POST</span> <span class="api-path">/api/v1/markets/capabilities/&#123;listingId&#125;/leases</span>
...
#### <span class="api-method api-get">GET</span> <span class="api-path">/api/v1/markets/capabilities/leases/&#123;leaseId&#125;</span>
...
#### <span class="api-method api-post">POST</span> <span class="api-path">/api/v1/markets/capabilities/leases/&#123;leaseId&#125;/actions/invoke</span>
...
#### <span class="api-method api-post">POST</span> <span class="api-path">/api/v1/markets/capabilities/leases/&#123;leaseId&#125;/actions/pause</span>
...
#### <span class="api-method api-post">POST</span> <span class="api-path">/api/v1/markets/capabilities/leases/&#123;leaseId&#125;/actions/resume</span>
...
#### <span class="api-method api-post">POST</span> <span class="api-path">/api/v1/markets/capabilities/leases/&#123;leaseId&#125;/actions/terminate</span>
...
#### <span class="api-method api-get">GET</span> <span class="api-path">/api/v1/contracts</span>
...
#### <span class="api-method api-post">POST</span> <span class="api-path">/api/v1/contracts</span>
...
#### <span class="api-method api-get">GET</span> <span class="api-path">/api/v1/contracts/&#123;contractId&#125;</span>
...
#### <span class="api-method api-post">POST</span> <span class="api-path">/api/v1/contracts/&#123;contractId&#125;/actions/sign</span>
...
#### <span class="api-method api-post">POST</span> <span class="api-path">/api/v1/contracts/&#123;contractId&#125;/actions/activate</span>
...
#### <span class="api-method api-post">POST</span> <span class="api-path">/api/v1/contracts/&#123;contractId&#125;/milestones/&#123;milestoneId&#125;/actions/submit</span>
...
#### <span class="api-method api-post">POST</span> <span class="api-path">/api/v1/contracts/&#123;contractId&#125;/milestones/&#123;milestoneId&#125;/actions/approve</span>
...
#### <span class="api-method api-post">POST</span> <span class="api-path">/api/v1/contracts/&#123;contractId&#125;/actions/dispute</span>
...
#### <span class="api-method api-get">GET</span> <span class="api-path">/api/v1/reputations/&#123;did&#125;</span>
...
#### <span class="api-method api-get">GET</span> <span class="api-path">/api/v1/reputations/&#123;did&#125;/reviews</span>
...
#### <span class="api-method api-post">POST</span> <span class="api-path">/api/v1/reputations/&#123;did&#125;/reviews</span>
