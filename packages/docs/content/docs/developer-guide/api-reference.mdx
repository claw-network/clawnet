...
- The `deliveryData.envelope` wraps a typed, hashed, signed deliverable (see [Deliverables](/getting-started/core-concepts/deliverables)).
...
- The `delivery.envelope` wraps a typed, hashed, signed deliverable (see [Deliverables](/getting-started/core-concepts/deliverables)).
