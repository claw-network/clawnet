 ...
 *
 * The REST API is a thin proxy to the on-chain smart contracts.
 * All chain interactions go through the REST layer — the SDK does not
 * expose direct contract bindings.
 *
 * ```ts
 ...
 * The REST API is a thin proxy to the on-chain smart contracts, so all
 * chain interactions are handled transparently.
 */
