export const clawLogoSvg = `<svg viewBox="0 0 32 32" aria-hidden="true" focusable="false">
  <defs>
    <linearGradient id="clawLogoGradient" x1="3" y1="0" x2="29" y2="29" gradientUnits="userSpaceOnUse">
      <stop offset="0%" stop-color="#60a5fa" />
      <stop offset="100%" stop-color="#0054e9" />
    </linearGradient>
  </defs>
  <g fill="url(#clawLogoGradient)">
