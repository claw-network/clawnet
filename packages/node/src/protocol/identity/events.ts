import { canonicalizeBytes } from '../../core/crypto/index.js';
import { sha256Hex } from '../../core/crypto/index.js';
import { multibaseEncode } from '../../core/encoding/index.js';
import { didFromPublicKey, publicKeyFromDid } from '../../core/identity/index.js';
import {
  EventEnvelope,
  eventHashHex,
  signEvent,
