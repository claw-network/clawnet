...
class DaoApi:
    ...
    def list_proposals(self, *, status: str | None = None) -> dict[str, Any]:
        ...
        return self._http.get("/api/v1/dao/proposals", params)

    def get_proposal(self, proposal_id: str) -> dict[str, Any]:
        """Get a single proposal by ID."""
        return self._http.get(
            f"/api/v1/dao/proposals/{quote(proposal_id, safe='')}"
        )

    def create_proposal(self, **kwargs: Any) -> dict[str, Any]:
        """Create a new proposal."""
        return self._http.post("/api/v1/dao/proposals", kwargs)

    def advance_proposal(self, proposal_id: str, **kwargs: Any) -> dict[str, Any]:
        """Advance a proposal to a new status."""
        return self._http.post(
            f"/api/v1/dao/proposals/{quote(proposal_id, safe='')}/actions/advance",
            kwargs,
        )
    ...
    def get_votes(self, proposal_id: str) -> dict[str, Any]:
        ...
        return self._http.get(
            f"/api/v1/dao/proposals/{quote(proposal_id, safe='')}/votes"
        )

    def vote(self, proposal_id: str, **kwargs: Any) -> dict[str, Any]:
        """Cast a vote on a proposal."""
        return self._http.post(
            f"/api/v1/dao/proposals/{quote(proposal_id, safe='')}/votes", kwargs
        )
    ...
    def delegate(self, **kwargs: Any) -> dict[str, Any]:
        ...
        return self._http.post("/api/v1/dao/delegations", kwargs)

    def revoke_delegation(self, delegate: str, **kwargs: Any) -> dict[str, Any]:
        """Revoke a delegation."""
        return self._http.delete(
            f"/api/v1/dao/delegations/{quote(delegate, safe='')}", body=kwargs
        )

    def get_delegations(self, did: str) -> dict[str, Any]:
        """Get delegations for a DID."""
        return self._http.get("/api/v1/dao/delegations", {"did": did})

    # ── Treasury ───────────────────────────────────────────────────────

    def get_treasury(self) -> dict[str, Any]:
        """Get current treasury status."""
        return self._http.get("/api/v1/dao/treasury")

    def deposit(self, **kwargs: Any) -> dict[str, Any]:
        """Deposit into the treasury."""
        return self._http.post("/api/v1/dao/treasury/deposits", kwargs)

    # ── Timelock ───────────────────────────────────────────────────────

    def list_timelock(self) -> dict[str, Any]:
        """List timelock entries."""
        return self._http.get("/api/v1/dao/timelock")

    def execute_timelock(self, action_id: str, **kwargs: Any) -> dict[str, Any]:
        """Execute a timelocked action."""
        return self._http.post(
            f"/api/v1/dao/timelock/{quote(action_id, safe='')}/actions/execute",
            kwargs,
        )
    ...
    def cancel_timelock(self, action_id: str, **kwargs: Any) -> dict[str, Any]:
        ...
        return self._http.post(
            f"/api/v1/dao/timelock/{quote(action_id, safe='')}/actions/cancel",
            kwargs,
        )
    ...
    def get_params(self) -> dict[str, Any]:
        ...
        return self._http.get("/api/v1/dao/params")
...
class AsyncDaoApi:
    ...
    async def list_proposals(self, *, status: str | None = None) -> dict[str, Any]:
        """List proposals, optionally filtered by status."""
        params: dict[str, Any] | None = {"status": status} if status else None
        return await self._http.get("/api/v1/dao/proposals", params)
    ...
    async def create_proposal(self, **kwargs: Any) -> dict[str, Any]:
        """Create a new proposal."""
        return await self._http.post("/api/v1/dao/proposals", kwargs)
    ...
    async def vote(self, proposal_id: str, **kwargs: Any) -> dict[str, Any]:
        """Cast a vote on a proposal."""
        return await self._http.post(
            f"/api/v1/dao/proposals/{quote(proposal_id, safe='')}/votes", kwargs
        )
    ...
    async def delegate(self, **kwargs: Any) -> dict[str, Any]:
        """Set delegation to another DID."""
        return await self._http.post("/api/v1/dao/delegations", kwargs)

    async def revoke_delegation(self, delegate: str, **kwargs: Any) -> dict[str, Any]:
        """Revoke a delegation."""
    ...
    async def get_delegations(self, did: str) -> dict[str, Any]:
        """Get delegations for a DID."""
        return await self._http.get("/api/v1/dao/delegations", {"did": did})

    # ── Treasury ───────────────────────────────────────────────────────

    async def get_treasury(self) -> dict[str, Any]:
        """Get current treasury status."""
        return await self._http.get("/api/v1/dao/treasury")

    async def deposit(self, **kwargs: Any) -> dict[str, Any]:
        """Deposit into the treasury."""
        return await self._http.post("/api/v1/dao/treasury/deposits", kwargs)

    # ── Timelock ───────────────────────────────────────────────────────

    async def list_timelock(self) -> dict[str, Any]:
        """List timelock entries."""
        return await self._http.get("/api/v1/dao/timelock")
    ...
    async def get_params(self) -> dict[str, Any]:
        """Get governance parameters and thresholds."""
        return await self._http.get("/api/v1/dao/params")
